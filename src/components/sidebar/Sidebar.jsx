...
export function SidebarResponsive(props) {
  ...
  //  Chakra Color Mode
  const mainText = useColorModeValue('gray.200', 'gray.200');
  let hamburgerColor = useColorModeValue('gray.900', 'gray.200');
  var brand = (
    <DarkMode>
      <Box pt={'35px'} mb="8px">
        <Box
  ...
  return (
    <DarkMode>
      <Flex display={{ sm: 'flex', xl: 'none' }} alignItems="center">
        <HamburgerIcon color={hamburgerColor} mt={1} w="19px" h="19px" cursor="pointer" ref={btnRef} onClick={onOpen} />
